...
#: The output directory for all log files generated by this application. 
OUT_DIR = __package__ + "_OUTPUT"
if not os.path.exists(OUT_DIR):
    os.mkdir(OUT_DIR)

#: The log directory within $OUT_DIR.
LOG_DIR = os.path.join(OUT_DIR, "Logs_" + __package__.capitalize())
